<%@ Page Title="eBill Admin | Edit Gateways " Language="C#" MasterPageFile="~/ui/SuperUserMasterPage.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Lync_Billing.ui.admin.gateways.edit" %>
    ...
    <div id='edit-gateways' class='block float-right wauto h100p'>
        <div class="block-body pt5">
            <ext:Panel
                ...
                <Content>
                    <div class="block-body p10 wauto hauto">
                        <ext:DateField 
                            ID="StartingDate"
                            runat="server" 
