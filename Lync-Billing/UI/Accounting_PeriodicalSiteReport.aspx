<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MasterPage.Master" AutoEventWireup="true" CodeBehind="Accounting_PeriodicalSiteReport.aspx.cs" Inherits="Lync_Billing.UI.Accounting_PeriodicalSiteReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main_content_place_holder" runat="server">
    ...
    <div id='manage-phone-calls-block' class='block float-right w80p h100p'>
        <div class="block-body pt5">
            <p class="font-18">Generate Periodical Sites Reports!</p>
        </div>
    </div>
