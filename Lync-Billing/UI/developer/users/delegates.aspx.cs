...
namespace Lync_Billing.ui.developer.users
{
    public partial class delegates : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string redirect_to = @"~/ui/developer/main/dashboard.aspx";
            ...
            else
            {
                ...
                if (session.ActiveRoleName != "developer")
                {
                    Response.Redirect("~/ui/session/authenticate.aspx?access=developer");
                }
            }
