<%@ Page Title="" Language="C#" MasterPageFile="~/ui/AccountingMaster.Master" AutoEventWireup="true" CodeBehind="monthlyReports.aspx.cs" Inherits="Lync_Billing.ui.accounting.monthly" %>
            ...
            <ext:Panel ID="AccountingToolsSidebar"
                ...
                <Content>
                    ...
                    <div class='sidebar-section'>
                        ...
                        <div class="sidebar-section-body">
                            <p><a href='../accounting/users/monthly.aspx' class="selected">Monthly Users Reports</a></p>
