...
namespace Lync_Billing.Backend
{
    public class DialingPrefixsRates
    {
        ...
        public static List<DialingPrefixsRates> GetRates(string ratesTableName)
        {
            ...
            dt = Backend.Rate.RATESTABLE_VIEW_PER_GATEWAY(ratesTableName);
        ...
        public static List<DialingPrefixsRates> GetRates(string ratesTableName, Int64 dialingPrefix)
        {
            ...
            dt = Backend.Rate.RATESTABLE_VIEW_PER_GATEWAY(ratesTableName, Enums.GetDescription(Enums.ActualRates.DialingPrefix), dialingPrefix);
        ...
        public static List<DialingPrefixsRates> GetRates(string ratesTableName, string countryCode)
        {
            ...
            dt = Backend.Rate.RATESTABLE_VIEW_PER_GATEWAY(ratesTableName, Enums.GetDescription(Enums.ActualRates.ThreeDigitsCountryCode), countryCode);
