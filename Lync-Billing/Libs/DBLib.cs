...
namespace Lync_Billing.Libs
{
    ...
    public class DBLib
    {
        //public static string ConnectionString_Lync = @"Provider=SQLOLEDB.1;Data Source=10.1..55;Persist Security Info=True;Password='=25_ar;p1100';User ID=sa;Initial Catalog=tBill";
